public class StringConCat{
    public static void main(String[] args){
        ...
        //Value assigned to age is retrieved from memory and prefixed to the string " years old.".]
        System.out.println(age + " years old.");

        /*Value assigned to age is retrieved  from memory and appended to the string "Age is "
        This produces a new string "Age is 20". Then the string "years old." is appended to 
        this new string "Age is 20" to give "Age is 20 years old".*/
